...
export const TOP_CAN_PLAY_THROUGH =
...
export const TOP_COMPOSITION_END =
  unsafeCastStringToDOMTopLevelType("compositionend");
export const TOP_COMPOSITION_START =
  unsafeCastStringToDOMTopLevelType("compositionstart");
export const TOP_COMPOSITION_UPDATE =
  unsafeCastStringToDOMTopLevelType("compositionupdate");
export const TOP_CONTEXT_MENU =
  unsafeCastStringToDOMTopLevelType("contextmenu");
...
export const TOP_DURATION_CHANGE =
  unsafeCastStringToDOMTopLevelType("durationchange");
...
export const TOP_GOT_POINTER_CAPTURE =
...
export const TOP_LOADED_METADATA =
  unsafeCastStringToDOMTopLevelType("loadedmetadata");
export const TOP_LOST_POINTER_CAPTURE =
...
export const TOP_POINTER_CANCEL =
  unsafeCastStringToDOMTopLevelType("pointercancel");
export const TOP_POINTER_DOWN =
  unsafeCastStringToDOMTopLevelType("pointerdown");
export const TOP_POINTER_ENTER =
  unsafeCastStringToDOMTopLevelType("pointerenter");
export const TOP_POINTER_LEAVE =
  unsafeCastStringToDOMTopLevelType("pointerleave");
export const TOP_POINTER_MOVE =
  unsafeCastStringToDOMTopLevelType("pointermove");
export const TOP_POINTER_OUT = unsafeCastStringToDOMTopLevelType("pointerout");
export const TOP_POINTER_OVER =
  unsafeCastStringToDOMTopLevelType("pointerover");
...
export const TOP_SELECTION_CHANGE =
...
export const TOP_TOUCH_CANCEL =
  unsafeCastStringToDOMTopLevelType("touchcancel");
...
export const TOP_VOLUME_CHANGE =
  unsafeCastStringToDOMTopLevelType("volumechange");
